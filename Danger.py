...
TOKEN = '7220634775:AAFPJ49MRfr0TH-HcjZ1KTQsHPATPVBdN8o'
MONGO_URI = 'mongodb+srv://Cluster0:Cluster0@cluster0.5mvg9ej.mongodb.net/danger?retryWrites=true&w=majority'
FORWARD_CHANNEL_ID = -1002245948926
CHANNEL_ID = -1002245948926
error_channel_id = -1002245948926
...
def help_command(message):
    ...
    markup = types.InlineKeyboardMarkup()
    button1 = types.InlineKeyboardButton(text="🔱 𝗖𝗢𝗡𝗧𝗔𝗖𝗧 𝗢𝗪𝗡𝗘𝗥 🔱", url="https://t.me/")
